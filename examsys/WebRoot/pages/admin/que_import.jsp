...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=request.getContextPath()%>/js/admin/que_import.js"></script>
		...
		<div class="wrapper" >
			<div class="page-content">
				<section class="column width6 first">
					...
					<form id="addQueForm" method="post">
					    <fieldset>
				    <legend>所需字段</legend>
				    	<p>
							<label class="required">类别:</label><br/>
							<input type="text" id="qcName" name="qcName" class="required half"/>
						</p>
			    		<p>
					    ...
					    <input type="hidden" id="qbId" value="${param.qbId}"/>
					</form>
				</section>
			</div>
